...
const account3 = {
  ...
  movementsDates: [
    ...
    '2022-12-25T06:04:23.907Z',
    '2022-01-25T14:18:46.235Z',
    '2022-08-09T16:33:06.386Z',
    '2023-08-10T14:43:26.374Z',
    '2023-09-12T18:49:59.371Z',
...
const startLogOutTimer = function () {
  ...
  const tick = function () {
    ...
    //when we reach 0 stop timer and log out user
    if (time === 0) {
      clearInterval(timer);
      labelWelcome.textContent = "Log in to your Jimmy's account";
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    labelDate.textContent = new Intl.DateTimeFormat(
      ...
      options
    ).format(now); //API for Date format
    //current Date
...
btnLoan.addEventListener('click', function (e) {
  ...
  if (amount > 0 && currentAccount.movements.some(mov => mov >= amount * 0.1)) {
    setTimeout(function () {
      ...
      //add loan date
      currentAccount.movementsDates.push(new Date().toISOString()); //without ISOString it turns this into an object
